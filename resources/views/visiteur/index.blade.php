        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @endguest
                    @auth
                       @hasanyrole('admin|Gestionnaire|editeur')
                            ...
                            <div class="mt-auto flex items-center justify-between">
                                @auth
                                    ...
                                    <form action="{{ route('favorite.store',$product->id) }}" method="POST">
                                        @method('PUT')
                                        @csrf
                                     <button type="submit" class="text-slate-400 hover:text-brand-600 relative group mr-4"
                                        title="Mes Favoris">
                                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                     ...
                                     <form action="{{ route('favorite.store',$product->id) }}" method="POST">
                                        @method('PUT')
                                        @csrf
                                     <button type="submit" class="text-brand-600 relative group" title="Mes Favoris">
